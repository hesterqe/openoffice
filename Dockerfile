...
RUN yum -y install java-11-openjdk && yum -y clean all && \
    wget --no-check-certifiate https://sourceforge.net/projects/openofficeorg.mirror/files/4.1.7/binaries/en-US/Apache_OpenOffice_4.1.7_Linux_x86-64_install-rpm_en-US.tar.gz && \
